        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="officeleaderindex.jsp" class="site_title"><i class="fa fa-mortar-board"></i>
                        <span>欢迎登录！</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li>
                                <a href="officeleaderindex.jsp"><i class="fa fa-home"></i> 主页 </a>
                            </li>
                            <li>
                                <a><i class="fa fa-upload"></i> 预警标准制定 <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li>
                                        <a href="../common/warningtandardupload.jsp">预警标准制定</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li>
                                        <a href="../common/schoolhelp.jsp">全校帮扶结果信息</a>
                                    </li>
                                    <li>
