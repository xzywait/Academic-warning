        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="classteacherindex.jsp" class="site_title"><i class="fa fa-mortar-board"></i>
                        <span>欢迎登录！</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li>
                                <a href="classteacherindex.jsp"><i class="fa fa-home"></i> 主页 </a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li>
                                        <a href="../common/helpstandard.jsp">班级帮扶信息</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                                                                    ...
                                                                    <div class="x_panel tile fixed_height_auto">
                                                                        ...
                                                                        <div class="x_content">
                                                                            ...
                                                                            <div class="col-md-offset-2 col-md-5 col-sm-offset-2 col-sm-5 col-xs-offset-2 col-xs-5"
                                                                                 style="margin-top: 3%;background-color: #f0fae4;">
                                                                                <div class="x_title">
                                                                                    <h2 style="font-family: '微软雅黑';color: black;">
                                                                                        各类型预警</h2>
                                                                                    <div class="clearfix"></div>
                                                                                </div>
                                                                                <div class="x_content">
                                                                    ...
                                                                    <div class="x_panel tile fixed_height_auto">
                                                                        ...
                                                                        <div class="x_content">
                                                                            <div class="col-md-12 col-sm-12 col-xs-12"
                                                                                 style="margin-top: 3%;background-color: #fac696;">
                                                                                <div class="x_title">
                                                                                    <h2 style="font-family: '微软雅黑';font-size:large;font-weight: bold;color: black;">
                                                                                        总览</h2>
                                                                                    <div class="clearfix"></div>
                                                                                </div>
                                                                                <div class="x_content">
                                                                                    <table class="" id="helpallnum"
                                                                                           style="width:100%;color: #000000;">
                                                                                        <tr>
                                                                                            <th>
                                                                                                <p>总数</p>
                                                                            ...
                                                                            <div class="col-md-offset-2 col-md-5 col-sm-offset-2 col-sm-5 col-xs-12"
                                                                                ...
                                                                                <div class="x_content">
                                                                                    <table class="" id="professionalnum"
                                                                                           style="width:100%;color: black;">
                                                                                        <tr>
                                                                                            <th>
                                                                                                <p>总数</p>
