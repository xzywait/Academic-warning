            ...
            <div class="title_right">
                <div class="col-md-3 col-sm-3 col-xs-12 form-group pull-right top_search">
                    <div class="input-group">
                        <a href="../common/classwarning.jsp" class="btn btn-success personalinformation"><i
                                class="fa fa-angle-double-left"></i>&nbsp;&nbsp;返回上级列表</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="x_content">
                        <div class="col-md-4 col-sm-4 col-xs-12 profile_left">
                            <div class="profile_img">
                                <div id="crop-avatar">
                                    <!-- Current avatar -->
                                    <img id="stuindeximg" class="img-responsive avatar-view" src="../images/picture.jpg"
                                         alt="Avatar" title="Change the avatar" width="220" height="220">
                                </div>
                            </div>
                            ...
                            <a href="../common/personalinformation.jsp" class="btn btn-success personalinformation"><i
