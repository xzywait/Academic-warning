        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="helppeopleindex.jsp" class="site_title"><i class="fa fa-mortar-board"></i>
                        <span>欢迎登录！</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        <ul class="nav side-menu">
                            <li>
                                <a href="helppeopleindex.jsp"><i class="fa fa-home"></i> 主页 </a>
                            </li>
                            <li>
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li>
                                        <a href="../common/classwarning.jsp">学生预警信息<span class="badge bg-green">8</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <div class="x_content">
                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 profile_left">
                                        <div class="profile_img">
                                            <div id="crop-avatar">
                                                <!-- Current avatar -->
                                                <img id="peoindeximg" class="img-responsive avatar-view"
                                        ...
                                        <br/>
                                        <!-- start skills -->
                                        <h3 style="margin-top: 50px;"> 帮扶学生总况 </h3>
                                        <p></p>
                                                                ...
                                                                <div class="x_panel tile fixed_height_auto">
                                                                    ...
                                                                    <div class="x_content">
                                                                        ...
                                                                        <div class="col-md-5 col-sm-5 col-xs-5"
                                                                            ...
                                                                            <div class="x_content">
                                                                                <table class="" id="stuswarnlevelnum"
                                                                                       style="width:100%;color: #000000;">
                                                                                    <tr>
                                                                                        <th>
                                                                                            <p>黄色预警</p>
                                                                        ...
                                                                        <div class="col-md-offset-2 col-md-5 col-sm-offset-2 col-sm-5 col-xs-offset-2 col-xs-5"
                                                                            ...
                                                                            <div class="x_content">
                                                                                <table class="" id="stuswarntypenum"
                                                                                       style="width:100%;color: #000000;">
                                                                                    <tr>
                                                                                        <th>
                                                                                            <p>学分预警</p>
                                                                ...
                                                                <div class="x_panel tile fixed_height_auto">
                                                                    ...
                                                                    <div class="x_content">
                                                                        ...
                                                                        <div class="col-md-offset-2 col-md-5 col-sm-offset-2 col-sm-5 col-xs-12"
                                                                            ...
                                                                            <div class="x_content">
                                                                                <table class="" id="stusprofessionalnum"
                                                                                       style="width:100%;color: #000000;">
                                                                                    <tr>
                                                                                        <th>
                                                                                            <p>总数</p>
                                                                        ...
                                                                        <div class="col-md-5 col-sm-5 col-xs-12 "
                                                                            ...
                                                                            <div class="x_content">
                                                                                <table class="" id="stustelephonenum"
                                                                                       style="width:100%;color: #000000;">
                                                                                    <tr>
                                                                                        <th>
                                                                                            <p>总数</p>
